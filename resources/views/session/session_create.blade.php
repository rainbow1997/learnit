                        ...
                        <form method="POST" class="" action="../Sessions_Management">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" id="term_id" name="term_id" onclick="handleChangeTerm();">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" id="lesson_id" name="lesson_id" onclick="handleChangeTerm();">
